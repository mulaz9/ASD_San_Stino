...
"use strict"; // Show menu

var hamburger = document.querySelector(".hamburger");
var menu = document.querySelector(".menu");
var menuLine1 = document.querySelector(".line--1");
var menuLine2 = document.querySelector(".line--2");
var menuLine3 = document.querySelector(".line--3");
var headerText = document.querySelectorAll(".slide--text");
var menuIsOpened = false;

var showMenu = function showMenu() {
  hamburger.addEventListener("click", function () {
    if (!menuIsOpened) {
      headerText.forEach(function (txt) {
        return txt.style.opacity = 0;
      });
