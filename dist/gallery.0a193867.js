...
const singlePhotoContainer = document.querySelector(".single--photo--container");
const params = new URLSearchParams(window.location.search);
const id = params.get("id");
const getPhoto = async function() {
    const response = await fetch(`http://localhost:1337/api/galleries/${id}?populate=foto`);
...
//# sourceMappingURL=gallery.0a193867.js.map
